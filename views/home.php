...
?>
 ...
 <div class="no-bottom no-top" id="content">
                ...
                <section aria-label="section" data-bgimage="url(/assets/images/background/2.jpg) top">
                    <div class="container">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-5 offset-lg-1 wow fadeInRight" data-wow-delay=".5s">
                                <div class="spacer-10"></div>
                                 <div class="h1">Help to improve focus<br>
                                    for more
                    ...
                    <div class="container">
                        ...
                        <div class="col-lg-4 col-md-6 mb30">
                            <div class="feature-box f-boxed style-3">
                                <i class="bg-color i-circle fa fa-music"></i>
                                <div class="text">
                                    <h4>HD Sounds</h4>
                                    Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem.
                                </div>
                                <i class="wm fa fa-music"></i>
                            </div>
                        </div>
                        
                        <div class="col-lg-4 col-md-6 mb30">
                            <div class="feature-box f-boxed style-3">
                                <i class="bg-color i-circle fa fa-list-ol"></i>
                                <div class="text">
                                    <h4>Playlist</h4>
                                    Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem.
                                </div>
                                <i class="wm fa fa-list-ol"></i>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6 mb30">
                            <div class="feature-box f-boxed style-3">
                                <i class="bg-color i-circle fa fa-heartbeat"></i>
                                <div class="text">
                                    <h4>Mood Detector</h4>
                                    Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem.
                                </div>
                                <i class="wm fa fa-heartbeat"></i>
                            </div>
                        </div>

                        <div class="col-lg-4 col-md-6 mb30">
                            <div class="feature-box f-boxed style-3">
                                <i class="bg-color i-circle fa fa-random"></i>
                                <div class="text">
                                    <h4>Shuffle</h4>
                                    Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem.
                                </div>
                                <i class="wm fa fa-random"></i>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6 mb30">
                            <div class="feature-box f-boxed style-3">
                                <i class="bg-color i-circle fa fa-hourglass-start"></i>
                                <div class="text">
                                    <h4>Timer</h4>
                                    Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem.
                                </div>
                                <i class="wm fa fa-hourglass-start"></i>
                            </div>
                        </div>
                ...
                <section id="section-banner" class="border-top">
                    <div class="container">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-5 offset-md-1 wow fadeInLeft" data-wow-delay="0s">
                              ...
                              <li class="nav-item">
                                <a class="nav-link active" id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="true">Sleep</a>
                              </li>
                              <li class="nav-item">
                                <a class="nav-link" id="pills-profile-tab" data-toggle="pill" href="#pills-profile" role="tab" aria-controls="pills-profile" aria-selected="false">Focus</a>
                              </li>
                              <li class="nav-item">
                                <a class="nav-link" id="pills-contact-tab" data-toggle="pill" href="#pills-contact" role="tab" aria-controls="pills-contact" aria-selected="false">Relax</a>
                              </li>
                            </ul>
                            ...
                            <div id="accordion-1" class="accordion">
                                ...
                                <div class="card">
                                    <div id="heading-a1" class="card-header bg-white shadow-sm border-0">
                                        <h6 class="mb-0 font-weight-bold"><a href="#" data-toggle="collapse" data-target="#collapse-a1" aria-expanded="false" aria-controls="collapse-a1" class="d-block position-relative text-dark collapsible-link py-2">How do i get the app for my phone?</a></h6>
                                    </div>
                                ...
                                <div class="card">
                                    <div id="heading-a2" class="card-header bg-white shadow-sm border-0">
                                        <h6 class="mb-0 font-weight-bold"><a href="#" data-toggle="collapse" data-target="#collapse-a2" aria-expanded="false" aria-controls="collapse-a2" class="d-block position-relative collapsed text-dark collapsible-link py-2">What plan I should choose?</a></h6>
                                    </div>
                                ...
                                <div class="card">
                                    <div id="heading-a3" class="card-header bg-white shadow-sm border-0">
                                        <h6 class="mb-0 font-weight-bold"><a href="#" data-toggle="collapse" data-target="#collapse-a3" aria-expanded="false" aria-controls="collapse-a3" class="d-block position-relative collapsed text-dark collapsible-link py-2">What happen to my app if I stop paying?</a></h6>
                                    </div>
                            ...
                            <div id="accordion-2" class="accordion">
                                ...
                                <div class="card">
                                    <div id="heading-b1" class="card-header bg-white shadow-sm border-0">
                                        <h6 class="mb-0 font-weight-bold"><a href="#" data-toggle="collapse" data-target="#collapse-b1" aria-expanded="false" aria-controls="collapse-b1" class="d-block position-relative text-dark collapsible-link py-2">Does it have in-app purchases?</a></h6>
                                    </div>
                                ...
                                <div class="card">
                                    <div id="heading-b2" class="card-header bg-white shadow-sm border-0">
                                        <h6 class="mb-0 font-weight-bold"><a href="#" data-toggle="collapse" data-target="#collapse-b2" aria-expanded="false" aria-controls="collapse-b2" class="d-block position-relative collapsed text-dark collapsible-link py-2">Can I use this app on multiple devices?</a></h6>
                                    </div>
                                ...
                                <div class="card">
                                    <div id="heading-b3" class="card-header bg-white shadow-sm border-0">
                                        <h6 class="mb-0 font-weight-bold"><a href="#" data-toggle="collapse" data-target="#collapse-b3" aria-expanded="false" aria-controls="collapse-b3" class="d-block position-relative collapsed text-dark collapsible-link py-2">Is my phone supported for this app?</a></h6>
                                    </div>
            ...
            <!-- section close -->
                ...
                <section id="section-testimonial" class="border-top">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="text-center">
                ...
                <section id="section-fun-facts" class="pt60 pb60 border-top">
                    <div class="container">
                    <div class="row">
                        <div class="col-md-3">
                ...
                <section aria-label="section" class="no-top no-bottom border-top">
                    <div class="container">
                        <div class="row align-items-center">
                            <div class="col-md-6">
                                ...
                                <a href="download.html"><img src="/assets/images/misc/download-appstore.png" class="img-fluid" alt="download"></a>&nbsp;
                                <a href="download.html"><img src="/assets/images/misc/download-playstore.png" class="img-fluid" alt="download"></a>
                            </div>

                            <div class="col-md-6 text-center">
                                <img src="/assets/images/misc/2.png" class="img-fluid" alt="">
                            </div>
                        </div>
                    </div>
                </section>
